...
class HotelDAO(BaseDAO):
    ...
    @classmethod
    async def find_hotel_by_location_and_date(cls, location: str, date_from: date, date_to: date):
        """
        ...
        async with async_session_maker() as session:
            # logger.debug(get_hotels_with_rooms.compile(async_engine, compile_kwargs={"literal_binds": True}))
